...
class greenworld_barcode extends PaymentModule {
    ...
    public function uninstall(){
        if (!Configuration::deleteByName('gw_barocde_encryption')
            OR !Configuration::deleteByName('gw_barocde_mer_id')
            OR !parent::uninstall())
            return false;
    }
    ...
    private function _displayForm(){
        $mer_id=Configuration::get('gw_barocde_mer_id');
        $encryption_code=Configuration::get('gw_barocde_encryption');
        $this->_html .= '  
    ...
    public function getContent(){
        if (Tools::isSubmit('submit')){  
            if(!sizeof ($this->_postErrors)){
                ...
                Configuration::updateValue('gw_barocde_mer_id', Tools::getValue('shop_code'),true);
                Configuration::updateValue('gw_barocde_encryption', Tools::getValue('encryption_code'),true);
