...
define("_iMODULE_FIRST_TITLE_CVS_","使用CVS"); 
...
class greenworld_cvs extends PaymentModule {
    ...
    public function uninstall(){
        if (!Configuration::deleteByName('gw_cvs_encryption')
            OR !Configuration::deleteByName('gw_cvs_mer_id')
            OR !parent::uninstall())
            return false;
    }
    
    public function getEncryptionCode(){
        $encryption_code=Configuration::get('gw_cvs_encryption');
    ...
    private function _displayForm(){
        $mer_id=Configuration::get('gw_cvs_mer_id');
        $encryption_code=Configuration::get('gw_cvs_encryption');
        $this->_html .= '  
    ...
    public function getContent(){
        if (Tools::isSubmit('submit')){  
            if(!sizeof ($this->_postErrors)){
                ...
                Configuration::updateValue('gw_cvs_mer_id', Tools::getValue('shop_code'),true);
                Configuration::updateValue('gw_cvs_encryption', Tools::getValue('encryption_code'),true);
