 ...
 * @author 李泓承 
 */
define("_iMODULE_NAME_ECPAY3_","greenworld_ecpay3"); //設定 Class的name。
define("_iMODULE_CHINESE_NAME_ECPAY3_","綠界－ECPAY分3期繳費"); 
define("_iMODULE_DESCRUPTION_ECPAY3_","提供管理者在Prestashop網站上，使用綠界科技的ECPAY分3期繳費"); 
define("_iMODULE_UNINSTALL_MESSAGE_ECPAY3_","Are you sure you want to delete your details ?"); 
define("_iMODULE_FIRST_TITLE_ECPAY3_","使用ECPAY3_"); 
define("_iMODULE_VERSION_ECPAY3_","1.0.0"); 
class greenworld_ecpay3 extends PaymentModule {
    ...
    function __construct(){  
        $this->name = _iMODULE_NAME_ECPAY3_;
        
        parent::__construct();
        $this->path=$this->_path;
        $this->tab = 'payments_gateways';  
        $this->version = _iMODULE_VERSION_ECPAY3_;  
        $this->displayName = $this->l(_iMODULE_CHINESE_NAME_ECPAY3_);  
        $this->description = $this->l(_iMODULE_DESCRUPTION_ECPAY3_);
        $this->confirmUninstall = $this->l(_iMODULE_UNINSTALL_MESSAGE_ECPAY3_);    }
    ...
    public function getEncryptionCode(){
        $encryption_code=Configuration::get('gw_ecpay3_encryption');
    ...
    public function uninstall(){
        if (!Configuration::deleteByName('gw_ecpay3_encryption')
            OR !Configuration::deleteByName('gw_ecpay3_mer_id')
            OR !parent::uninstall())
            return false;
    }
    ...
    public function getContent(){
        if (Tools::isSubmit('submit')){  
            if(!sizeof ($this->_postErrors)){
                ...
                Configuration::updateValue('gw_ecpay3_mer_id', Tools::getValue('shop_code'),true);
                Configuration::updateValue('gw_ecpay3_encryption', Tools::getValue('encryption_code'),true);
