<p class="payment_module">
	<a href="{$link->getModuleLink('greenworld_ecpay6', 'payment', [], true)}" title="{l s='Pay by ecpay6.' mod='greenworld_ecpay6'}">
		{l s='使用綠界ECPAY分6期付款.' mod='greenworld_'}
	</a>
</p>
<!--
<a href="javascript:$('#greenworld_ecpay6').submit();" title="{$payment}">
...
<p class="payment_module">
	<a href="{$link->getModuleLink('greenworld_ecpay6', 'validation', [], true)}" title="{l s='Pay by check.' mod='cheque'}">
