...
define("_iMODULE_CHINESE_NAME_IBON_","綠界－7-Eleven ibon繳費"); 
define("_iMODULE_DESCRUPTION_IBON_","提供管理者在Prestashop網站上，使用綠界科技的7-Eleven ibon繳費"); 
define("_iMODULE_UNINSTALL_MESSAGE_IBON_","Are you sure you want to delete your details ?"); 
define("_iMODULE_FIRST_TITLE_IBON_","使用7-Eleven ibon繳費"); 
...
class greenworld_ibon extends PaymentModule {
    ...
    function __construct(){  
       ...
       */
        ...
        $this->PaymentType="ibon";                                  //設定訂單付費方式
    ...
    public function getContent(){
     ...
     public function hookPayment($params){
        global $smarty;
        $smarty->assign('payment',$this->l(_iMODULE_FIRST_TITLE_IBON_));    
