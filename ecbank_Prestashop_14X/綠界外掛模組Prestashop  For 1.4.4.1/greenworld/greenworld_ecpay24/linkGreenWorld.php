...
include_once(dirname(__FILE__).'/greenworld_ecpay24.php');
include_once(dirname(__FILE__).'/../../classes/OrderHistory.php');

session_start();

global $cookie;
$CheckPay=new greenworld_ecpay24();
$authorized = false;
...
$InstallmentTotal=(int)($inttotal*( 1 +  ($CheckPay->get24Percentage()/100) ) );
...
if(!session_is_registered("checkStep")){
    ...
    if ($total==0){
        echo Module::display(_iMODULE_NAME_ECPAY_24_,'ErrorStep.tpl');
        session_destroy(); 
    }else{
        $_SESSION["checkStep"]="1";
        echo Module::display(_iMODULE_NAME_ECPAY_24_,'validationOrder.tpl');
    }
    ...
    echo Module::display(_iMODULE_NAME_ECPAY_24_,'sentToEcPay.tpl');
