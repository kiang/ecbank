...
<form action="{$this_path}linkGreenWorld.php?check=1" method="post">
	...
	<p>
                ...
                系統會將您所購買的<font color='red'>{$total}</font>金額轉為正整數<font color='red'>{$inttotal}</font>。<BR/><BR/>

                由於您所選擇的是<font color="red">分24期</font>購買，分期總金額將會是<font color="red">{$InstallmentTotal}</font>。<BR/><BR/>
                <font color="red">注意：</font><font color="blue">目前尚未提供分期零利率功能，所以分期金額將額外加入。</font><BR/>
                

                以上說明如確認無誤並認同，請按下方<font color='red'>同意</font>按鈕開始進行付費機制。<BR /><BR/>
