...
define("_iMODULE_CHINESE_NAME_PAYPAL_","綠界－PAYPAL 繳費"); 
...
define("_iMODULE_FIRST_TITLE_PAYPAL_","使用PAYPAL繳費"); 
...
class greenworld_paypal extends PaymentModule {
    ...
    function __construct(){  
       ...
       */
        ...
        $this->PaymentType="paypal";                               //設定訂單付費方式
    ...
    public function getContent(){
     ...
     public function hookPayment($params){
        global $smarty;
        $smarty->assign('payment',$this->l(_iMODULE_FIRST_TITLE_PAYPAL_));    
