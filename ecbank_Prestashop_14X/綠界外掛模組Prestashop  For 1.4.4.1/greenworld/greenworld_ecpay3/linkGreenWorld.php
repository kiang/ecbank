...
$InstallmentTotal=(int)($inttotal*( 1 +  ($CheckPay->get3Percentage()/100) ) );
...
if(!session_is_registered("checkStep")){
    ...
    if ($total==0){
        echo Module::display(_iMODULE_NAME_ECPAY_3_,'ErrorStep.tpl');
        session_destroy(); 
    }else{
        $_SESSION["checkStep"]="1";
        echo Module::display(_iMODULE_NAME_ECPAY_3_,'validationOrder.tpl');
    }
    ...
    echo Module::display(_iMODULE_NAME_ECPAY_3_,'sentToEcPay.tpl');
