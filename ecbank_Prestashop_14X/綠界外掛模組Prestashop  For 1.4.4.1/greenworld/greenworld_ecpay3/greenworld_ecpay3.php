 ...
 * @author 李泓承 
 */
define("_iMODULE_NAME_ECPAY_3_","greenworld_ecpay3"); //設定 Class的name。
define("_iMODULE_CHINESE_NAME_ECPAY_3_","綠界－線上分3期刷卡繳費"); 
define("_iMODULE_DESCRUPTION_ECPAY_3_","提供管理者在Prestashop網站上，使用綠界科技的線上分3期刷卡繳費"); 
define("_iMODULE_UNINSTALL_MESSAGE_ECPAY_3_","Are you sure you want to delete your details ?"); 
define("_iMODULE_FIRST_TITLE_ECPAY_3_","使用線上分3期刷卡繳費"); 
define("_iMODULE_VERSION_ECPAY_3_","1.0.0"); 
class greenworld_ecpay3 extends PaymentModule {
    private $_html='';
    ...
    function __construct(){  
        $this->name = _iMODULE_NAME_ECPAY_3_;
        
        parent::__construct();
        $this->path=$this->_path;
        $this->tab = 'payments_gateways';  
        $this->version = _iMODULE_VERSION_ECPAY_3_;  
        $this->displayName = $this->l(_iMODULE_CHINESE_NAME_ECPAY_3_);  
        $this->description = $this->l(_iMODULE_DESCRUPTION_ECPAY_3_);
        $this->confirmUninstall = $this->l(_iMODULE_UNINSTALL_MESSAGE_ECPAY_3_);
    ...
    private function _displayForm(){  
        ...
        <form action="'.$_SERVER['REQUEST_URI'].'" method="post">   
                <div class="margin-form">  
                    ...
                    3期利率：<input type="text" name="3_percentage" value="'.$this->_3_percent.'" size="10" /><br />
    ...
    public function getContent(){
        if (Tools::isSubmit('submit')){  
            if(!sizeof ($this->_postErrors)){
                ...
                Configuration::updateValue($this->name.'_3_percent', Tools::getValue('3_percentage'),true);
        ...
        if(!Configuration::get($this->name.'_3_percent')==null){
            $this->_3_percent=Configuration::get($this->name.'_3_percent');
        }else{
            $this->_3_percent='Enter Percentage Code';
        }
     ...
     public function hookPayment($params){
        global $smarty;
        $smarty->assign('payment',$this->l(_iMODULE_FIRST_TITLE_ECPAY_3_));    
    ...
    public function get3Percentage(){
        $tempReturn="";
        if(Configuration::get($this->name.'_3_percent') ){
            $tempReturn=Configuration::get($this->name.'_3_percent');
        }else{
            $tempReturn="Error_Shop_Check_Code";
        }
        return $tempReturn;
