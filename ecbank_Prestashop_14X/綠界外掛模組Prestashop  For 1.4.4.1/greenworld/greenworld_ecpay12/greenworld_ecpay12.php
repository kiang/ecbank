 ...
 * @author 李泓承 
 */
define("_iMODULE_NAME_ECPAY_12_","greenworld_ecpay12"); //設定 Class的name。
define("_iMODULE_CHINESE_NAME_ECPAY_12_","綠界－線上分12期刷卡繳費"); 
define("_iMODULE_DESCRUPTION_ECPAY_12_","提供管理者在Prestashop網站上，使用綠界科技的線上分12期刷卡繳費"); 
define("_iMODULE_UNINSTALL_MESSAGE_ECPAY_12_","Are you sure you want to delete your details ?"); 
define("_iMODULE_FIRST_TITLE_ECPAY_12_","使用線上分12期刷卡繳費"); 
define("_iMODULE_VERSION_ECPAY_12_","1.0.0"); 
class greenworld_ecpay12 extends PaymentModule {
    private $_html='';
    ...
    function __construct(){  
        $this->name = _iMODULE_NAME_ECPAY_12_;
        
        parent::__construct();
        $this->path=$this->_path;
        $this->tab = 'payments_gateways';  
        $this->version = _iMODULE_VERSION_ECPAY_12_;  
        $this->displayName = $this->l(_iMODULE_CHINESE_NAME_ECPAY_12_);  
        $this->description = $this->l(_iMODULE_DESCRUPTION_ECPAY_12_);
        $this->confirmUninstall = $this->l(_iMODULE_UNINSTALL_MESSAGE_ECPAY_12_);
    ...
    private function _displayForm(){  
        ...
        <form action="'.$_SERVER['REQUEST_URI'].'" method="post">   
                <div class="margin-form">  
                    ...
                    12期利率：<input type="text" name="12_percentage" value="'.$this->_12_percent.'" size="10" /><br />
    ...
    public function getContent(){
        if (Tools::isSubmit('submit')){  
            if(!sizeof ($this->_postErrors)){
                ...
                Configuration::updateValue($this->name.'_12_percent', Tools::getValue('12_percentage'),true);
        ...
        if(!Configuration::get($this->name.'_12_percent')==null){
            $this->_12_percent=Configuration::get($this->name.'_12_percent');
        }else{
            $this->_12_percent='Enter Percentage Code';
        }
     ...
     public function hookPayment($params){
        global $smarty;
        $smarty->assign('payment',$this->l(_iMODULE_FIRST_TITLE_ECPAY_12_));    
    ...
    public function get12Percentage(){
        $tempReturn="";
        if(Configuration::get($this->name.'_12_percent') ){
            $tempReturn=Configuration::get($this->name.'_12_percent');
        }else{
            $tempReturn="Error_Shop_Check_Code";
        }
        return $tempReturn;
