 ...
 * @author 李泓承 
 */
define("_iMODULE_NAME_ECPAY_6_","greenworld_ecpay6"); //設定 Class的name。
define("_iMODULE_CHINESE_NAME_ECPAY_6_","綠界－線上分6期刷卡繳費"); 
define("_iMODULE_DESCRUPTION_ECPAY_6_","提供管理者在Prestashop網站上，使用綠界科技的線上分6期刷卡繳費"); 
define("_iMODULE_UNINSTALL_MESSAGE_ECPAY_6_","Are you sure you want to delete your details ?"); 
define("_iMODULE_FIRST_TITLE_ECPAY_6_","使用線上分6期刷卡繳費"); 
define("_iMODULE_VERSION_ECPAY_6_","1.0.0"); 
class greenworld_ecpay6 extends PaymentModule {
    private $_html='';
    ...
    function __construct(){  
        $this->name = _iMODULE_NAME_ECPAY_6_;
        
        parent::__construct();
        $this->path=$this->_path;
        $this->tab = 'payments_gateways';  
        $this->version = _iMODULE_VERSION_ECPAY_6_;  
        $this->displayName = $this->l(_iMODULE_CHINESE_NAME_ECPAY_6_);  
        $this->description = $this->l(_iMODULE_DESCRUPTION_ECPAY_6_);
        $this->confirmUninstall = $this->l(_iMODULE_UNINSTALL_MESSAGE_ECPAY_6_);
    ...
    private function _displayForm(){  
        ...
        <form action="'.$_SERVER['REQUEST_URI'].'" method="post">   
                <div class="margin-form">  
                    ...
                    6期利率：<input type="text" name="6_percentage" value="'.$this->_6_percent.'" size="10" /><br />
    ...
    public function getContent(){
        if (Tools::isSubmit('submit')){  
            if(!sizeof ($this->_postErrors)){
                ...
                Configuration::updateValue($this->name.'_6_percent', Tools::getValue('6_percentage'),true);
        ...
        if(!Configuration::get($this->name.'_6_percent')==null){
            $this->_6_percent=Configuration::get($this->name.'_6_percent');
        }else{
            $this->_6_percent='Enter Percentage Code';
        }
     ...
     public function hookPayment($params){
        global $smarty;
        $smarty->assign('payment',$this->l(_iMODULE_FIRST_TITLE_ECPAY_6_));    
    ...
    public function get6Percentage(){
        $tempReturn="";
        if(Configuration::get($this->name.'_6_percent') ){
            $tempReturn=Configuration::get($this->name.'_6_percent');
        }else{
            $tempReturn="Error_Shop_Check_Code";
        }
        return $tempReturn;
