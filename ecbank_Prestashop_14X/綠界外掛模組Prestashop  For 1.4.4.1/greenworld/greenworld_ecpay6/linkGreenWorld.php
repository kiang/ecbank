...
include_once(dirname(__FILE__).'/greenworld_ecpay6.php');
...
if(!session_is_registered("checkStep")){
    ...
    if ($total==0){
        echo Module::display(_iMODULE_NAME_ECPAY_6_,'ErrorStep.tpl');
        session_destroy(); 
    }else{
        $_SESSION["checkStep"]="1";
        echo Module::display(_iMODULE_NAME_ECPAY_6_,'validationOrder.tpl');
    }
    ...
    echo Module::display(_iMODULE_NAME_ECPAY_6_,'sentToEcPay.tpl');
