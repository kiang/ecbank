 ...
 <BODY>
	<div id="header">
		<div class="wrap s_clear">
			<h2><center><a href="http://www.ecbank.com.tw/"><img src="plugins/greenworld/greenworld_banner.png" alt="綠界ECBANK" border="0" /></a></center></h2>
			</div>
	</div>
	<CENTER>
...
?>
	...
	<div id="index" style="background-color:white;width:500px;">
		<a href="index.php">回首頁</a>　　<img src="plugins/greenworld/greenworld_logo.jpg" alt="綠界金流" border="0" />
	</div>
	</CENTER>
...
<SCRIPT type="text/javascript">
	...
	function hide_options(f){
		var msg = "很抱歉，管理者設定此插件有誤，請嘗試聯絡管理者!!";
		switch (f){
		case 'vacc':
		case 'webatm':
		case 'barcode':
...
<?php
		...
		echo "<div style='background-color:white;'>很抱歉，管理者設定此插件有誤，請嘗試聯絡管理者!!</div>";
	}
}else{
	echo "<div style='background-color:white;'>很抱歉，管理者尚未啟動此插件，請嘗試聯絡管理者!!</div>";
}
?>