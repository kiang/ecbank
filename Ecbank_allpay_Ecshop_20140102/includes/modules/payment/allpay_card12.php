...
$payment_lang = ROOT_PATH . 'languages/' . $GLOBALS['_CFG']['lang'] . '/payment/allpay_card12.php';
...
if (isset($set_modules) && $set_modules == TRUE) {
    ...
    /* 描述对应的语言项 */
    $modules[$i]['desc'] = 'allpay_card12_desc';
    ...
    $modules[$i]['config'] = array(
        array('name' => 'allpay_card12_account', 'type' => 'text', 'value' => '1111'),
        array('name' => 'allpay_card12_iv', 'type' => 'text', 'value' => 'iv'),
        array('name' => 'allpay_card12_key', 'type' => 'text', 'value' => 'key')
    );
    return;
}
...
class allpay_card12 {
    ...
    function get_code($order, $payment) {
        ...
        $c_mid = trim($payment['allpay_card12_account']);
        $log_id = $order['log_id'];
        ...
        $key = trim($payment['allpay_card12_key']);
        $iv = trim($payment['allpay_card12_iv']);
    ...
    function respond() {
        ...
        //exit;
        $payment = get_payment('allpay_card12');
