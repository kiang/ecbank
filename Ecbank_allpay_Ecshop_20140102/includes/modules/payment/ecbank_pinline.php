...
$payment_lang = ROOT_PATH . 'languages/' .$GLOBALS['_CFG']['lang']. '/payment/ecbank_pinline.php';
...
if (isset($set_modules) && $set_modules == TRUE)
{
    ...
    /* 描述对应的语言项 */
    $modules[$i]['desc']    = 'ecbank_pinline_desc';
    ...
    /* 版本号 */
    $modules[$i]['version'] = 'V1.6';

    /* 配置信息 */
    $modules[$i]['config']  = array(
        array('name' => 'ecbank_pinline_account',           'type' => 'text',   'value' => '1111'),
        array('name' => 'ecbank_pinline_checkcode',         'type' => 'text',   'value' => '12742742'),
       	array('name' => 'ecbank_pinline_language',	    'type' => 'select', ' value' => '0'),
        array('name' => 'ecbank_pinline_inv_active',              'type' => 'select',	'value' => '0'),
        array('name' => 'ecbank_pinline_inv_mer_id',              'type' => 'text',         'value' => '')
    );
    return;
}
...
class ecbank_pinline
{
    ...
    function respond()
    {
		...
		//驗證碼
		$checkcode = trim($payment['ecbank_pinline_checkcode']);
