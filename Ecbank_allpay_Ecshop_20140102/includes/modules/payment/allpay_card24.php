...
$payment_lang = ROOT_PATH . 'languages/' . $GLOBALS['_CFG']['lang'] . '/payment/allpay_card24.php';
...
if (isset($set_modules) && $set_modules == TRUE) {
    ...
    /* 描述对应的语言项 */
    $modules[$i]['desc'] = 'allpay_card24_desc';
    ...
    $modules[$i]['config'] = array(
        array('name' => 'allpay_card24_account', 'type' => 'text', 'value' => '1111'),
        array('name' => 'allpay_card24_iv', 'type' => 'text', 'value' => 'iv'),
        array('name' => 'allpay_card24_key', 'type' => 'text', 'value' => 'key')
    );
    return;
}
