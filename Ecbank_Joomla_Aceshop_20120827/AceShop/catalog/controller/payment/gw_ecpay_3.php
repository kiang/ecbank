...
class ControllerPaymentGwEcpay3 extends Controller {
	protected function index() {
		...
		$roturl = HTTPS_SERVER . 'index.php?route=payment/gw_ecpay_3/callback'; //付款完畢觸發網址
		$bk_posturl = HTTPS_SERVER . 'index.php?route=payment/gw_ecpay_3/bk_callback';
		...
		//$this->data['continue'] = HTTPS_SERVER . 'index.php?route=checkout/gw_ecpay_3_respond';//完成結帳網址
	...
	public function callback() {
		if (
			...
			$ecbank_gateway = HTTP_SERVER . 'index.php?route=checkout/gw_ecpay_3_respond';
