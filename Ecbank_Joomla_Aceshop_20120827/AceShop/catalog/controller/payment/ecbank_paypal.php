...
class ControllerPaymentEcbankPaypal extends Controller {
	protected function index() {
		...
		$return_url = HTTPS_SERVER . 'index.php?route=payment/ecbank_paypal/callback'; // 付款完成通知網址
	...
	public function confirm() {
		...
		if(!isset($this->session->data['doubleclick'])){
			...
			$this->session->data['doubleclick'] = $doubleclick; //未更新至主機
	...
	public function callback() {
		...
		$ecbank_gateway = HTTP_SERVER . 'index.php?route=checkout/ecbank_paypal_success';
