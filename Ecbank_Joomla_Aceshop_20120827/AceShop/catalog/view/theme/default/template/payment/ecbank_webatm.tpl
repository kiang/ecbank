...
function checkTotal(){
	...
	if(total>=10 && total<=2000000){		
		$.ajax({ 
		type: 'GET',
		url: 'index.php?route=payment/ecbank_webatm/confirm',
		success: function() {
...
<div style="background: #F7F7F7; border: 1px solid #DDDDDD; padding: 10px; margin-bottom: 10px;"><?php echo $text_payment; ?><br /><br />
	<?php echo ($ecbank_webatm_description == "") ? "" : $text_instruction . "<br /><font color='#FF9900'>" . $ecbank_webatm_description . "</font><br />"; ?>	
  <br />
</div>
<div class="buttons">
