...
function checkTotal(){
	var total = <?php echo $total; ?>;				
		$.ajax({ 
		type: 'GET',
		url: 'index.php?route=payment/gw_ecpay/confirm',
		success: function() {
...
<div class="buttons" style="border: 1px solid #DDDDDD; border-top: 0px; padding: 10px; margin-bottom: 0px;<?php echo ($gw_ecpay_description == "") ? " display:none;" : "";?>">
	<?php echo ($gw_ecpay_description == "") ? "" : $text_instruction . "<br /><font color='#FF9900'>" . $gw_ecpay_description . "</font><br />"; ?>
</div>
