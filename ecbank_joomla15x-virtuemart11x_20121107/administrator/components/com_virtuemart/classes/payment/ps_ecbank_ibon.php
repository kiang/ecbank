...
*
*
* @version $Id: ps_ecbank_ibon.php,v 1.0 2010/03/16 12:00:02  $
* @package VirtueMart
* @subpackage payment
...
class ps_ecbank_ibon {

    var $classname = "ps_ecbank_ibon";
    ...
    */
    function show_configuration() {
        ...
        <tr>
              ...
              <td><input type="text" name="ECBANK_IBON_MID" class="inputbox" value="<?php  echo ECBANK_IBON_MID ?>" /></td>
              <td>綠界 ECPAY 商店代號</td>
          </tr>
          <tr>
          <td align="center"><strong>交易加密私鑰</strong></td>
              <td>
                  <input name="ECBANK_IBON_CHECKCODE" type="text" class="inputbox" value="<?php echo ECBANK_IBON_CHECKCODE ?>" size="30" />
              </td>
...
$param = array (
 ...
 // 您的ECBank商店代號
 'mer_id' => ECBANK_IBON_MID,
 // 商店設定在ECBank管理後台的交易加密私鑰
 'enc_key' => ECBANK_IBON_CHECKCODE,
 ...
 // 付款完成通知網址
 'ok_url' => rawurlencode(SECUREURL.'administrator/components/com_virtuemart/ecbank_ibon_notify.php' )
);
...
<table width=90% border=1 align=center cellpadding=3 cellspacing=1>
  <tr>
    ...
    <td width=235 bgcolor=#FFFF99>7-11 ibon 代碼繳費</td>
  </tr>
  <tr>
    <td align=center>ibon繳費代碼</td>
    <td>'.$res['payno'].'</td>
  </tr>
  <tr>
  ...
  <tr>
    <td colspan=2 align=center><a href=http://www.ecbank.com.tw/expenses-ibon.htm target=_blank>7-11 ibon 門市操作步驟</a></td>
  </tr>
  <tr>
    <td colspan=2><strong class=mycolor>請記下上列超商繳費代碼,至最近之7-11便利商店,操作ibon代碼繳費機台, 於列印出有調碼之繳款單後,至櫃台支付,便可完成繳費,繳費之收據請留存以供備核,繳費之後才算完成購物流程</strong></td>
  </tr>
  <tr>
  ...
  /**
   ...
   function write_configuration( &$d ) {
      ...
      $my_config_array = array(
      				"ECBANK_IBON_MID" => $d['ECBANK_IBON_MID'],
              		"ECBANK_IBON_CHECKCODE" => $d['ECBANK_IBON_CHECKCODE']
	  );
     $config = "<?php\n";
