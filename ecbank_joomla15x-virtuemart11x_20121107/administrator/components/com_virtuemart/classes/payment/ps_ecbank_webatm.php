...
class ps_ecbank_webatm {

    var $classname = "ps_ecbank_webatm";
    ...
    function show_configuration() {
        ...
        <table width="70%" align="center">
          ...
          <td width="16%" align="center"><strong>商店代號</strong></td>
              <td width="53%">
                  <input type="text" name="ECBANK_WEBATM_MID" class="inputbox" value="<?php  echo ECBANK_WEBATM_MID; ?>" />              </td>
              <td width="31%">綠界 ECBANK 商店代號              </td>
          </tr>
          <tr>
          <td align="center"><strong>檢查碼</strong></td>
              <td>
            <input name="ECBANK_WEBATM_CHECKCODE" type="text" class="inputbox" value="<?php  echo ECBANK_WEBATM_CHECKCODE ?>" size="30" />              </td>
  ...
  echo '
	...
	<input type="hidden" name="mer_id" value='.ECBANK_WEBATM_MID.'>
	<input type="hidden" name="payment_type" value="'.$param['payment_type'].'">
    <input type="hidden" name="setbank" value='.$param["setbank"].'>
	<input type="hidden" name="od_sob" value='.$param["od_sob"].'>
	<input type="hidden" name="amt" value="'.$param["amt"].'">
	<input type="hidden" name="return_url" value='.SECUREURL.'index.php?option=com_virtuemart&amp;page=checkout.ecbank_webatm_result&amp;order_id='.$db->f("order_id").' />
	<!input type="hidden" name="return_url" value="'.SECUREURL.'administrator/components/com_virtuemart/ecbank_webatm_notify.php">
  ...
  /**
   ...
   function write_configuration( &$d ) {
      ...
      $my_config_array = array(
      				"ECBANK_WEBATM_MID" => $d['ECBANK_WEBATM_MID'],
              		"ECBANK_WEBATM_CHECKCODE" => $d['ECBANK_WEBATM_CHECKCODE']
